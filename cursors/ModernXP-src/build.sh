...
function create {
	...
	mkdir -p 32 64 96
	cd "$SRC"/$1
	find . -name "*.svg" -type f -exec sh -c 'inkscape -o "../32/${0%.svg}.png" -w 32 -h 32 $0' {} \;
	find . -name "*.svg" -type f -exec sh -c 'inkscape -o "../64/${0%.svg}.png" -w 64 -h 64 $0' {} \;
	find . -name "*.svg" -type f -exec sh -c 'inkscape -o "../96/${0%.svg}.png" -w 96 -h 96 $0' {} \;
